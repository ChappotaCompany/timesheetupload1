		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comchappotatimesheettimesheetupload-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotatimesheettimesheetupload-display": {
								"semanticObject": "comchappotatimesheettimesheetupload",
								"action": "display",
								"description": "Timesheet Upload",
								"title": "Timesheet Upload",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.timesheet.timesheetupload",
									"url": sap.ui.require.toUrl("com/chappota/timesheet/timesheetupload")
								}
							}
						}
					}
